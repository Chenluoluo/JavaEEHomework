...
public class MailTool {
    ...
    public static String myEmailAccount = "17614261765@163.com";
    public static String myEmailPassword = "Cx123456";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1789062317@qq.com";
...
//        session.setDebug(true);                                 // 设置为debug模式, 可以查看详细的发送 log
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount, mail);
