			...
			<form method="post" action="login.do"
				...
				<div class="uk-form-row">
					<div class="uk-form-icon uk-width-1-1">
						<i class="uk-icon-envelope-o"></i> <input v-model="username"
							name="username" type="text" placeholder="<fmt:message key="user.login.username" />" maxlength="50"
				...
				<div class="uk-form-row">
					<div class="uk-form-icon uk-width-1-1">
						<i class="uk-icon-lock"></i> <input v-model="passwd"
							name="password" type="password" placeholder="<fmt:message key="user.login.password" />" maxlength="50"
							class="uk-width-1-1 uk-form-large">
					</div>
				</div>
				<!-- 登录按钮 -->
				<div class="uk-form-row">
					<button type="submit"
						...
						<i class="uk-icon-sign-in"></i> <fmt:message key="user.login.login" />
					</button>
				</div>
			</form>
			<div class="uk-form-row">
				<a href="register.jsp">
					<button type="submit"
						...
						>
						<i class="uk-icon-sign-in"></i> <fmt:message key="user.login.register" />
					</button>
				</a>
			</div>
		</div>
