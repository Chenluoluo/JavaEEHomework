		...
		<div class="uk-vertical-align-middle" style="width: 320px">
			...
			<form method="post" action="register.do"
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						<input name="name" v-model="name" type="text" maxlength="50"
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						<input name="email" v-model="email" type="text" maxlength="50"
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						<input name="phone" v-model="phone" type="text" maxlength="50"
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						<input name="password1" v-model="password1" type="password"
							maxlength="50"
